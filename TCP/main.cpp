...
int main()
{
	...
	int serverPort = 9876;
	char received[256];
	string sent; //사용자가 입력한 문자열을 서버로 보내기 위해서 만들어 준 것 
	...
	serverAddress.sin_family = AF_INET; // IPv4 형식으로 
	serverAddress.sin_addr.s_addr = inet_addr("127.0.0.1"); //4바이트 정수를 네트워크 바이트 형식으로
